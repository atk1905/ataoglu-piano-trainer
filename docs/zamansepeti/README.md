...
Bu klasör, ZamanSepeti.org için oluşturulmuş beş alternatif strateji varyantı, nihai sentez ve web sayfası varyantlarını içerir.
...
- `web/variant-4-kanki.html` — Kanki temalı editorial MVP landing page
- `web/variant-5-synthesis.html` — tüm varyantların güçlü yanlarını birleştiren sentez landing page
